			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="row">
					<div class="col-sm-12 blog-main">
						<form id="frm" class="form-horizontal" role="form" method="post" action="<%=request.getContextPath() %>/postUpdate" enctype="multipart/form-data">
							<h2 class="sub-header">게시판 수정</h2><br>
							<input type="hidden" name="post_no" id="post_no" value="${postVo.post_no }">
							
							<div class="form-group">
								<label for="pic" class="col-sm-2 control-label">제목</label>
								<div class="col-sm-6">
									<input type="text" class="form-control" id="post_title" name="post_title" placeholder="제목" value="${postVo.post_title }" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea name="post_content" id="post_content" rows="10" cols="100" style="width:766px; height:412px;">${postVo.post_content }</textarea>
								</div>
							</div>
								...
								<div id="file" class="col-sm-10">
									...
									<ul class="list-unstyled file-list">
										<c:forEach items="${fileList }" var="fileVo">
											<li style="margin-bottom:10px;"><label>${fileVo.file_name }</label></li>
										</c:forEach>
									</ul>
								</div>
							</div>					
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<button type="submit" id="savebutton" class="btn btn-default pull-right">저장</button>
								</div>
							</div>						
						</form>
					</div>
